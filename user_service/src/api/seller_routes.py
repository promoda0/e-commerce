...
from user_service.src.auth.dependencies import get_current_seller
...
def get_seller_profile(current_user: User = Depends(get_current_seller)) -> UserPublicResponse:
